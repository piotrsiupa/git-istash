...
git config --local advice.istashAaa false
git config --local advice.istashBbb 0
git config --local advice.istashCcc off
...
git config --local advice.istashAaa true
git config --local advice.istashBbb 1
git config --local advice.istashCcc on
assert_exit_code 0 './is_hint_enabled.sh' 'Aaa'
assert_outputs '' ''
assert_exit_code 0 './is_hint_enabled.sh' 'Bbb'
assert_outputs '' ''
