...
assert_exit_code 128 get_color 'red' 'color.foo' 'color.alittleworsecolor'
...
assert_exit_code 128 get_color 'red' 'color.foo' 'color.bar'
...
assert_exit_code 128 get_color 'red' 'color.foo' 'color.alittleworsecolor' 'color.somethirdcolor'
...
assert_exit_code 128 get_color 'red' 'color.foo' 'color.bar' 'color.somethirdcolor'
...
assert_exit_code 128 get_color 'red' 'color.foo' 'color.alittleworsecolor' 'color.baz'
...
assert_exit_code 128 get_color 'red' 'color.foo' 'color.bar' 'color.baz'
