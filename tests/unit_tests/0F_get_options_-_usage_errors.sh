...
assert_exit_code 2 get_options
...
assert_exit_code 2 get_options 'ab:cad' ''
...
assert_exit_code 2 get_options 'ab:cb:d' ''
...
assert_exit_code 2 get_options 'ab:ca:d' ''
assert_outputs '' 'fatal: option -a repeats in options definition for get_options'

__test_section__ 'With duplicated long option (without arguments)'
assert_exit_code 2 get_options '' 'thingy,other,something:,other,object'
...
assert_exit_code 2 get_options '' ',other:,something:,object'
...
assert_exit_code 2 get_options '' 'thingy,other:,,object'
assert_outputs '' 'fatal: empty entry in long options definition for get_options'

__test_section__ 'With unnamed long option (at the end)'
assert_exit_code 2 get_options '' 'thingy,other:,something:,'
assert_outputs '' 'fatal: empty entry in long options definition for get_options'

__test_section__ 'With unnamed short option (starts with ":")'
assert_exit_code 2 get_options ':ab:cd' ''
...
assert_exit_code 2 get_options '' 'thingy,other::,something:,object'
...
assert_exit_code 2 get_options '' 'thingy,other:,somet:hing,object'
...
assert_exit_code 2 get_options 'ab:
cd' ''
assert_outputs '' 'fatal: white character in short options definition for get_options'
...
assert_exit_code 2 get_options '' 'thingy,other:,
something:,object'
assert_outputs '' 'fatal: white character in long options definition for get_options'
