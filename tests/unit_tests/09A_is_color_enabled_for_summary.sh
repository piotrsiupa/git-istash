...
git config set --local color.status always
assert_exit_code 0 './is_color_enabled_for_summary.sh'
assert_outputs '' ''

__test_section__ 'never <- never'
git config set --local color.status never
assert_exit_code 1 './is_color_enabled_for_summary.sh'
assert_outputs '' ''
...
git config set --local color.istash.summary always
assert_exit_code 0 './is_color_enabled_for_summary.sh'
assert_outputs '' ''

__test_section__ 'never <- never <- never <- never'
git config set --local color.istash.summary never
assert_exit_code 1 './is_color_enabled_for_summary.sh'
assert_outputs '' ''
