...
assert_exit_code 0 get_color 'red' 'color.foo'
assert_outputs '\[31m' ''
...
assert_exit_code 0 get_color 'red' 'color.foo' 'color.alittleworsecolor'
assert_outputs '\[32m' ''

__test_section__ 'with default value and two variables, second non-existing'
assert_exit_code 0 get_color 'red' 'color.thebestcolor' 'color.bar'
assert_outputs '\[1;36m' ''

__test_section__ 'with default value and two non-existing variables'
assert_exit_code 0 get_color 'red' 'color.foo' 'color.bar'
assert_outputs '\[31m' ''


__test_section__ 'with default value and three existing variables, variant 0'
assert_exit_code 0 get_color 'red' 'color.thebestcolor' 'color.alittleworsecolor' 'color.somethirdcolor'
assert_outputs '\[1;36m' ''

__test_section__ 'with default value and three existing variables, variant 1'
assert_exit_code 0 get_color 'red' 'color.foo' 'color.alittleworsecolor' 'color.somethirdcolor'
assert_outputs '\[32m' ''

__test_section__ 'with default value and three existing variables, variant 2'
assert_exit_code 0 get_color 'red' 'color.thebestcolor' 'color.bar' 'color.somethirdcolor'
assert_outputs '\[1;36m' ''

__test_section__ 'with default value and three existing variables, variant 3'
assert_exit_code 0 get_color 'red' 'color.foo' 'color.bar' 'color.somethirdcolor'
assert_outputs '\[34m' ''

__test_section__ 'with default value and three existing variables, variant 4'
assert_exit_code 0 get_color 'red' 'color.thebestcolor' 'color.alittleworsecolor' 'color.baz'
assert_outputs '\[1;36m' ''

__test_section__ 'with default value and three existing variables, variant 5'
assert_exit_code 0 get_color 'red' 'color.foo' 'color.alittleworsecolor' 'color.baz'
assert_outputs '\[32m' ''

__test_section__ 'with default value and three existing variables, variant 6'
assert_exit_code 0 get_color 'red' 'color.thebestcolor' 'color.bar' 'color.baz'
assert_outputs '\[1;36m' ''

__test_section__ 'with default value and three existing variables, variant 7'
assert_exit_code 0 get_color 'red' 'color.foo' 'color.bar' 'color.baz'
assert_outputs '\[31m' ''
