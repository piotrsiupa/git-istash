...
#shellcheck disable=SC2086
assert_exit_code 1 git istash apply $QUIET_FLAGS "$CONTINUE_FLAG" $COLOR_FLAGS
...
#shellcheck disable=SC2086
assert_exit_code 0 git istash pop $QUIET_FLAGS "$CONTINUE_FLAG" $COLOR_FLAGS $SUMMARY_FLAGS
