...
__test_section__ 'Continue apply stash (0)'
...
#shellcheck disable=SC2086
assert_exit_code 1 git $ADVICE_FLAGS istash apply $QUIET_FLAGS "$CONTINUE_FLAG" $COLOR_FLAGS
...
#shellcheck disable=SC2086
assert_exit_code 0 git $ADVICE_FLAGS istash pop $QUIET_FLAGS "$CONTINUE_FLAG" $COLOR_FLAGS $SUMMARY_FLAGS
