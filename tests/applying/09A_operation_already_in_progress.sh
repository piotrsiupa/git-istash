...
assert_exit_code 2 git istash "$APPLY_OPERATION" $COLOR_FLAGS $QUIET_FLAGS $SUMMARY_FLAGS
...
#shellcheck disable=SC2086
assert_exit_code 1 git istash "$APPLY_OPERATION" $COLOR_FLAGS $QUIET_FLAGS $SUMMARY_FLAGS
...
#shellcheck disable=SC2086
assert_exit_code 0 git istash "$APPLY_OPERATION" "$CONTINUE_FLAG" $COLOR_FLAGS $QUIET_FLAGS $SUMMARY_FLAGS
