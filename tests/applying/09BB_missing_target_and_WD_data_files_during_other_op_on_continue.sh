...
assert_exit_code 1 git istash apply "$CONTINUE_FLAG"
assert_outputs__apply__missing_data_file 'apply' 'pop' 'ISTASH_TARGET' 'ISTASH_WORKING-DIR'
assert_files_HT '
M  aaa		ddd
   wdf0		wdf0b
!! ignored0	ignored0
...
assert_exit_code 0 git istash pop "$CONTINUE_FLAG"
