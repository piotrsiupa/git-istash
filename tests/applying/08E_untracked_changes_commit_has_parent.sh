...
untracked_files_commit_sha="$(git rev-parse HEAD)"
git reset --hard HEAD~
...
assert_exit_code 1 git istash apply "$stash_sha" $QUIET_FLAGS $COLOR_FLAGS
assert_outputs__apply__wrong_number_of_untracked_stash_parents "$stash_sha"
assert_files_HT '
   aaa		aaa
!! ignored0	ignored0
!! ignored1	ignored1
