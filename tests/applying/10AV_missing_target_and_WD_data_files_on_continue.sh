...
#shellcheck disable=SC2086
assert_exit_code 1 git istash pop $QUIET_FLAGS $COLOR_FLAGS "$CONTINUE_FLAG"
...
#shellcheck disable=SC2086
assert_exit_code 0 git istash pop $QUIET_FLAGS $COLOR_FLAGS $SUMMARY_FLAGS "$CONTINUE_FLAG"
