...
mkdir -p xxx
cd xxx
assert_exit_code 2 capture_outputs ../../../../../bin/git-istash "$APPLY_OPERATION"
cd -
...
git add aaa xxx/aaa yyy/aaa
cd xxx
assert_exit_code 2 capture_outputs ../../../../../bin/git-istash "$APPLY_OPERATION" "$CONTINUE_FLAG"
cd -
assert_conflict_message "$APPLY_OPERATION"
assert_files_HT '
UU aaa		eee0|ccc0
...
cd xxx
assert_exit_code 0 ../../../../../bin/git-istash "$APPLY_OPERATION" "$CONTINUE_FLAG"
cd -
assert_files_HT '
MM aaa		fff0	eee0
