...
mv .git/ISTASH_WORKING-DIR~ .git/ISTASH_WORKING-DIR
#shellcheck disable=SC2086
assert_exit_code 0 git $ADVICE_FLAGS istash 'pop' $COLOR_FLAGS "$ABORT_FLAG" $QUIET_FLAGS
