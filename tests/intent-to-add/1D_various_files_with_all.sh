...
assert_exit_code 0 git istash "$CREATE_OPERATION" $KEEP_INDEX_FLAGS $ALL_FLAGS $COLOR_FLAGS $UNSTAGED_FLAGS $STAGED_FLAGS $QUIET_FLAGS $UNTRACKED_FLAGS --message 'name of the new stash'
