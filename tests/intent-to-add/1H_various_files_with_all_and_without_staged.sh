...
assert_exit_code 0 git istash "$CREATE_OPERATION" $KEEP_INDEX_FLAGS $ALL_FLAGS $UNSTAGED_FLAGS $COLOR_FLAGS $STAGED_FLAGS $UNTRACKED_FLAGS --message 'name of the new stash'
