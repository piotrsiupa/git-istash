...
assert_exit_code 0 git istash "$CREATE_OPERATION" $COLOR_FLAGS $ALL_FLAGS $UNTRACKED_FLAGS $KEEP_INDEX_FLAGS $UNSTAGED_FLAGS $STAGED_FLAGS --message 'stash, not a trash' $QUIET_FLAGS
