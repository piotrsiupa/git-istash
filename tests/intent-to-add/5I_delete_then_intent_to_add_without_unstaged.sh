...
assert_exit_code 0 git istash "$CREATE_OPERATION" $ALL_FLAGS $UNTRACKED_FLAGS $KEEP_INDEX_FLAGS $UNSTAGED_FLAGS $QUIET_FLAGS $STAGED_FLAGS --message 'stash, not a trash' $COLOR_FLAGS
