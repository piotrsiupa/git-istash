...
assert_exit_code 0 git istash "$CREATE_OPERATION" $COLOR_FLAGS $UNSTAGED_FLAGS $STAGED_FLAGS $KEEP_INDEX_FLAGS $UNTRACKED_FLAGS $ALL_FLAGS --message 'name of this stash'
