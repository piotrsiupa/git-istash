...
assert_exit_code 0 git istash "$CREATE_OPERATION" $STAGED_FLAGS $UNSTAGED_FLAGS $UNTRACKED_FLAGS $ALL_FLAGS $QUIET_FLAGS $KEEP_INDEX_FLAGS --patch --message 'some nice stash name' $COLOR_FLAGS <.git/answers_for_patch
