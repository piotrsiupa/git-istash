...
assert_exit_code 0 git istash "$CREATE_OPERATION" $KEEP_INDEX_FLAGS $UNTRACKED_FLAGS $QUIET_FLAGS $STAGED_FLAGS $UNSTAGED_FLAGS $ALL_FLAGS $COLOR_FLAGS --message 'name of this stash'
