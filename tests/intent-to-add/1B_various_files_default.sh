...
assert_exit_code 0 git istash "$CREATE_OPERATION" $UNSTAGED_FLAGS $STAGED_FLAGS $KEEP_INDEX_FLAGS $ALL_FLAGS $UNTRACKED_FLAGS $COLOR_FLAGS --message 'name' $QUIET_FLAGS
