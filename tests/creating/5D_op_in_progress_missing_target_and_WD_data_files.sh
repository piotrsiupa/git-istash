...
assert_exit_code 2 git istash pop $QUIET_FLAGS $SUMMARY_FLAGS $COLOR_FLAGS
...
#shellcheck disable=SC2086
assert_exit_code 0 git istash pop $QUIET_FLAGS "$CONTINUE_FLAG" $SUMMARY_FLAGS $COLOR_FLAGS
