...
assert_exit_code 0 git istash "$CREATE_OPERATION" $KEEP_INDEX_FLAGS $QUIET_FLAGS $ALL_FLAGS $STAGED_FLAGS $UNSTAGED_FLAGS $UNTRACKED_FLAGS --message 'name of the new stash' $COLOR_FLAGS
