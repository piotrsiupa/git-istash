...
new_stash_hash_CO="$(assert_exit_code 0 ../../../../../lib/git-istash/git-istash-"$CREATE_OPERATION" $KEEP_INDEX_FLAGS $STAGED_FLAGS $UNSTAGED_FLAGS $ALL_FLAGS $UNTRACKED_FLAGS)"
cd -
if ! IS_KEEP_INDEX_ON
then
	assert_files_HTCO '
