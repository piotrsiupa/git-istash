...
assert_exit_code 0 ../../../../../lib/git-istash/git-istash-"$CREATE_OPERATION" $QUIET_FLAGS $KEEP_INDEX_FLAGS $COLOR_FLAGS $STAGED_FLAGS $UNSTAGED_FLAGS $ALL_FLAGS $UNTRACKED_FLAGS
cd -
