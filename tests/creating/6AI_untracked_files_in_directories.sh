...
printf 'z\n' >tracked-dir1/tracked-dir2/both
printf 'z\n' >tracked-dir1/tracked-dir2/changed-new
# And now the untracked files.
printf 'uf\n' >untracked-file
mkdir untracked-dir1
printf 'uf0\n' >untracked-dir1/untracked-file0
printf 'uf1\n' >untracked-dir1/untracked-file1
...
assert_exit_code 0 git istash "$CREATE_OPERATION" $KEEP_INDEX_FLAGS $UNSTAGED_FLAGS $COLOR_FLAGS $STAGED_FLAGS $ALL_FLAGS $QUIET_FLAGS $UNTRACKED_FLAGS
