...
assert_exit_code 0 git istash "$CREATE_OPERATION" $KEEP_INDEX_FLAGS $COLOR_FLAGS $STAGED_FLAGS $UNSTAGED_FLAGS $ALL_FLAGS $UNTRACKED_FLAGS --message 'name' $QUIET_FLAGS
