...
assert_exit_code 2 git istash pop $QUIET_FLAGS $COLOR_FLAGS $SUMMARY_FLAGS
...
#shellcheck disable=SC2086
assert_exit_code 0 git istash pop "$CONTINUE_FLAG" $QUIET_FLAGS $COLOR_FLAGS $SUMMARY_FLAGS
