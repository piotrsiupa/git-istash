...
assert_exit_code 0 git istash "$CREATE_OPERATION" $UNSTAGED_FLAGS $STAGED_FLAGS $KEEP_INDEX_FLAGS $QUIET_FLAGS $ALL_FLAGS $COLOR_FLAGS $UNTRACKED_FLAGS --message 'name'
